class Languages{
  ...
  [
    [
      'Uma uphupha amaklabishi, lokho kusho ukuthi kukhona umuntu oseduze nawe okhulelwe.',
    ],

    [
      'Uma uphupha udla utamatisi kusho ukuthi kungenzeka kudingeke usebenze kanzima kodwa uyowuthola umvuzo wezithukuthuku zakho.',
    ],

    [
      'Uma uphupha udla ithanga kusho izinto ezimbi ekusaseni lakho. Uzobhekana nezikhathi ezinzima khona maduze.',
    ],
    ...
    [
      'Uma uphupha udla uphizi oluhlaza osemusha kusho ukuthi uzoba nenhlanhla. Uma uphupha ngophizi owomile kusho ukuthi ezezimali zakho zingaba senkingeni.',
    ],

    [
      'Uma uphupha udla u-anyanisi kuyisibusiso esingesibusiso. Kusho ukuthi uzoba nomlingani othembekile kodwa kungenzeka nilwe izikhathi eziningi.',
    ],

    [
      'Uma uphupha udla ogalonci kusho ukuthi uzohlaselwa yizikhathi ezinzima kungekudala.',
    ],

    [
      'Uma uphupha udla imifino kusho ukuthi uzoba nenhlanhla. Amaphupho ngezitshalo.',
    ],
    ...
    [
      'Uma uphupha udla izaqathe kusho ukuthi uzochuma futhi ucebe.',
    ],

    [
      'Uma uphupha udla iklabishi kusho ukuthi uzoba nempilo ende ejabulisayo.',
    ],

    [
      'Uma uphupha udla ubhontshisi kusho ukuthi kungekudala uzohlangabezana nesiphithiphithi esizokubangela inkinga. Kodwa-ke kungasho ingcebo nenhlanhla uma ubhontshisi umningi kakhulu.',
    ],

    [
      'Uma uphupha ubona umuntu osebenzayo kusho ukuthi uzothuthuka.',
    ],

    [
      'Uma uphupha ubona amasosha noma amabutho kusho ukuthi kuza inkathazo.',
    ],

    [
      'Uma uphupha ubona itilosi kusho ukuthi maduzane uzothola izindaba ezimnandi ezisuka kude ngomuntu omaziyo.',
    ],
    ...
    [
      'Uma uphupha ubona umshayeli webhanoyi kungenzeka ukuthi awazi kodwa kukhona umuntu okwakhela ugobe futhi lowo muntu uzophumelela uma ungaqapheli.',
    ],

    [
      'Uma uphupha kukhona openda umuzi wakho kusho ukuthi izinto ezinhle zizokwenzeka maduzane.',
    ],

    [
      'Uma uphupha ubona umhlengikazi ngemvamisa kuyinhlanhla ngisho engenzi lutho. Kuyinhlanhla kakhulu uma engumuntu onakekela abantwana. Uma ugula uzoba ngcono maduzane. Amaphupho ngodokotela.',
    ],

    [
      'Uma uphupha ubona umlimi kusho ukuthi uzoba nenjabulo eningi empilweni yakho.',
    ],

    [
      'Uma uphupha ubona udokotela kuwuphawu oluhle. Kusho ukuthi uzoba nenhlanhla nempilo nempumelelo. Amaphupho ngezibhedlela. Uma uphupha uphuza umuthi.',
    ],

    [
      'Uma uphupha ubona umpheki kuyizindaba ezinhle ngaphandle uma ugula ngoba makunjalo kusho ukuthi kungenzeka ukuthi uzobhekana nobunzima. Uma unempilo kusho ukuthi amaphupho akho azofezeka futhi uzoba nempilo enenjabulo.',
    ],

    [
      'Uma uphupha ubona umbazi wamapulangwe kusho ukuthi uzophumelela emsebenzini futhi izinkinga zakho zizophela maduzane.',
    ],

    [
      'Uma uphupha ukuthi iqembu labantu bakha umuzi kukhona omaziyo okungenzeka adinge usizo lwakho maduzane. Uma udiliza amathuluzi abo kusho ukuthi uzomisa into embi ekwenzekeni.',
    ],

    [
      'Uma uphupha ubona isinqibi kukhona ozokulethela izindaba ezimbi maduzane kakhulu.',
    ],
    ...
    [
      'Uma uphupha ukuthi unohambo ngesitimela uzohlangana nomuntu okade wagcina ukumbona.',
    ],
    ...
    [
      'Uma uphupha ukuthi uyagwedla esikebheni emanzini kuwuphawu lenhlanhla uma nje isikebhe singacwili.',
    ],
    ...
    [
      'Uma uphupha ukuthi ubheka imephu kusho ukuthi uzohamba kude.',
    ],
    ...
    [
      'Uma uphupha ukuthi usebhasini kusho ukuthi maduzane uzothatha uhambo.',
    ],
    ...
    [
      'Uma uphupha ukuthi useyunivesithi/ usenyuvesi kusho ukuthi uhlakaniphile kakhulu futhi kufanele uzame ukusebenzisa amathalente akho emsebenzini wakho.',
    ],

    [
      'Uma uphupha ubhala isivivinyo uzobhekana nokuhlupheka maduzane nje. Kunabantu abafuna ukukujikela kodwa uma usebenza kanzima uzophumelela. Amaphupho ngesikole.',
    ],

    [
      'Uma uphupha ukuthi usesikoleni noma kuzobe kubukwa wena emhlanganweni olandelayo oya kuwo. Njengoba amaphupho enezincazelo ezahlukene, ukuphupha ngesikole kubuye kusho ukuthi kumele uthwase.',
    ],

    [
      'Uma uphupha ukuthi ubhala ngamapeni noyinki kusho ukuthi kufanele uqaphele ukungazikhandli kakhulu ngomsebenzi wakho wesikole.',
    ],

    [
      'Uma uphupha ukuthi usesikoleni noma wenza ikhozi kusho ukuthi uzophumelela empilweni. ',
    ],

    [
      'Uma uphupha ukuthi uthole iziqu noma uyagreda kodwa ungesona isitshudeni kusho ukuthi uhlakaniphile kodwa umosha ithalente lakho. ',
    ],
    ...
    [
      'Uma uphupha ukuthi ukhushuliwe emsebenzini uzophumelela emsebenzini wakho. Amaphupho ngomsebenzi. Amaphupho ngomqashi. Uma uphupha ukuthi uyaqhuga.',
    ],

    [
      'Uma uphupha ukuthi unikezwe umsebenzi omkhulu uzohlangabezana nezinkinga maduzane futhi kuzofanele usebenze kanzima uma ufuna ukuphumelela.',
    ],

    [
      'Uma uphupha ubona umqashi wakho kusho ukuthi uzoba nezinkinga emsebenzini uma ungaqapheli ukuthi wenzani. ',
    ],
    ...
    [
      'Uma uphupha ubona imvu kusho ukuthi izinto ezinhle zizokwehleka kuwe. Eyodwa nje imvu isho ukuthi uzochuma emsebenzini ikakhulukazi uma imnyama. Iqulu lezimvu lisho ukuthi uzophumelela futhi ube nomshado ojabule nonobuqotho).',
    ],

    [
      'Uma uphupha ubona inqama kusho ukuthi uzoba neshwa ekusaseni lakho. ',
    ],

    [
      'Uma uphupha ubona inkabi futhi ihlanzekile futhi imhlophe kusho ukuthi uyokwaziwa ngezinjongo zakho ezimsulwa kanye nenhliziyo enhle.',
    ],
    ...
    [
      'Uma uphupha ubona ihansi kusho ukuthi uzochuma futhi uphumelele emsebenzini wakho ikakhulukazi uma lenza umsindo.',
    ],

    [
      'Uma uphupha ubona imbuzi kusho ukuthi uzoba nenhlanhla uma imbuzi imhlophe kodwa ishwa uma imnyama.',
    ],

    [
      'Uma uphupha ubona amadada uzochuma futhi uphumelele ingqobo nje uma ungawabulalanga. Kulesosimo kusho ishwa nenkinga.',
    ],
    ...
    [
      'Uma uphupha ubona inkunzi ngokujwayelekile kusho izinto ezimbi ekusaseni lakho. Kusho ukuthi kuzoba nenkohliso ukungqubuzana kanye nenkinga okuzokwehlela ikakhulukazi uma kuyinkunzi emnyama. ',
    ],
    ...
    [
      'Uma uphupha ubona ikati kuwuphawu olubi olusho ukuthi abantu osebenza nabo noma ophila nabo awukwazi ukubethemba.',
    ],
    ...
    [
      'Uma uphupha ukuthi udlala ivayolini kusho ukuthi ngelinye ilanga uzophumelela ube nodumo.',
    ],
    ...
    [
      'Uma uphupha ukuthi uzwa upiyano noma uyawudlala kusho ukuthi uzophoxeka maduzane uma ungaqapheli.',
    ],

    [
      'Uma uphupha uzwa kudlala isigingci kusho ukuthi uzoba nenhlanhla maduzane. Kodwa uma kunguwena odlala isigingci kusho izinto izimbi ekusaseni lakho.',
    ],

    [
      'Uma uphupha ukuthi uzwa kudlala umtshingo kusho ukuthi uzobhekana nobunzima maduzane. Kodwa uma kunguwena odlala umtshingo kusho ukuthi uzophumelela uthuthuke.',
    ],

    [
      'Uma uphupha ukuthi uzwa izigubhu kusho ukuthi kuzoba nokuxabana emzini wakho maduzane.',
    ],

    [
      'Uma uphupha ukuthi uzwa kukhala izinsimbi ezikhencezayo kusho ukuthi inhlanhla enhle iyeza kuwe.',
    ],

    [
      'Ukuphupha amakha, noma ngabe uyaziqhola ngawo, noma ngabe unukelwa yiphunga lawo elimnandi, konke kusho okuhle empilweni, emsebenzini noma kwezothando.',
    ],

    [
      'Uma uphupha ukuthi unuka amakha kusho ukuthi kuzokuhambela kahle ebudlelwaneni bakho nabanye nasemsebenzini.',
    ],

    [
      'Uma uphupha ukuthi unuka iphunga elimnandi kuwuphawu oluhle ngekusasa lakho.',
    ],

    [
      'Uma uphupha ukuthi uzwa uphunga elibi kusho ukuthi kuzoba nolaka empilweni yakho.',
    ],

    [
      'Uma uphupha ukuthi uzwa isandla sewashi sihamba kusho ukuthi uzoba nempilo enenjabulo.',
    ],
    ...
    [
      'Uma uphupha ukuthi uzwa umsakazo kusho ukuthi kufanele uyovakashela isihlobo esisanda kukuvakashela.',
    ],

    [
      'Uma uphupha ukuthi uzwa ifoni/ ucingo lukhala kusho ukuthi abantu bahleba ngawe futhi kuzoletha izinkinga ebudlelwaneni bakho nabanye. Uma uphupha ukuthi ubona ucingo lokubiyela kusho ukuthi uzoba yisigwili ekusaseni lakho kodwa kungathatha isikhathi.',
    ],

    [
      'Uma uphupha ukuthi uzwa umculo ojabulisayo ephusheni lakho lokho kusho ukuthi uzothola izindaba ezimnandi maduzane nje. Kodwa uma uzwa umculo ongemnandi kusho ukuthi uzothola izindaba ezimbi.',
    ],

    [
      'Uma uphupha ukuthi uzwa umsindo omkhulu kusho ukuthi uzodinga ukwenza isinqumo esibalulekile maduzane.',
    ],

    [
      'Uma uphupha ukuthi uzwa ukungqongqoza emnyango wakho useduzane nokufinyelela izinhloso zakho kodwa kufanele uqaphele ukuthi usho into elungile ukuze ungalahlekelwa amathuba akho.',
    ],

    [
      'Uma uphupha ukuthi uzwa inja ihlaba umkhulungwane kusho ukuthi kunezinto ezimbi ezizayo. Uzoba nezikhathi ezinobunzima nokulwa maduzane.',
    ],
    ...
    [
      'Uma uphupha ukuthi ugqitshwe uphila kufanele uqaphele ngoba uzoba nesikhathi esinzima nebhadi maduzane – ikakhulukazi uma ungumuntu wesilisa.',
    ],

    [
      'Uma uphupha ukuthi unqunywe ikhanda kusho ukuthi uzokhululwa ezintweni ezikukhathazayo empilweni.',
    ],

    [
      'Uma uphupha ukuthi izihlobo zakho ezikude sezashona uzoba nenhlanhla maduzane. Uma uphupha ukuthi zisaphila uzothola izindaba ezimbi maduzane kakhulu.',
    ],

    [
      'Uma uphupha ukuthi umama wakho nobaba wakho sebashona bobabili kusho ukuthi uzothola usizo maduzane kumuntu noma endaweni engalindelekile.',
    ],

    [
      'Uma uphupha ukuthi ubona umshana wakho kusho ukuthi uzobona izihlobo maduzane futhi zizokusiza ngenkinga empilweni yakho. ',
    ],
    ...
    [
      'Uma uphupha ubona ukhokho wakho ongowesifazane kusho ukuthi kunenkathazo ezayo.',
    ],
    ...
    [
      'Uma uphupha ukuthi ulalele intshumayelo kusho ukuthi kuzokwenzeka izinto ezinhle kuwe ikakhulukazi uma isihlobo sikusiza.'
    ],

    [
      'Uma uphupha ukuthi uyaphenduka ngento oyenzile kusho ukuthi ugcina imfihlo ongayitshela umuntu ongafanele maduzane uma ungacopheleli.'
    ],
    ...
    [
      'Uma uphupha ukuthi ufela inkolo yakho kusho ukuthi uzoba nenjabulo nokwaneliseka empilweni.'
    ],
    ...
    [
      'Uma uphupha ukuthi ubona izingelosi kusho ukuthi umuntu omthandayo kungenzeka ukuthi udinga usizo.'
    ],
    ...
    [
      'Uma uphupha ukuthi uthuka inhlamba kusho ukuthi uzolahlekelwa umngani maduzane. Uma uzwa omunye umuntu ethuka inhlamba kusho ukuthi uzoba nenhlanhla.'
    ],

    [
      'Uma uphupha ukuthi uyacula kusho ukuthi uzothola izindaba ezimbi maduzane futhi ungaba nesikhathi esinzima ekusaseni lakho. Unenhlanhla kodwa ngoba kuzoba nabantu abalungile eduzane abazokusiza kuso.'
    ],

    [
      'Uma uphupha ukuthi abantu bakulalele usho inkondlo kuwuphawu oluhle kakhulu ngekusasa lakho. Kusho ukuthi ngelinye ilanga uzoduma ezweni lakho ngalokhu okwenzayo.'
    ],
    ...
    [
      'Uma uphupha usendaweni yokusebenza kusho inhlanhla kanye nokuchuma ekusaseni lakho.'
    ],

    [
      'Uma uphupha usezitebeleni kusho ukuthi uyoba nobudlelwane obude obujabulisayo nomlingani wakho kanye nabathandiweyo.'
    ],

    [
      'Uma uphupha usepaki kuyinhlanhla yekusasa lakho. Kusho ukuthi uyoba nenjabulo nempumelelo kanye nobudlelwane obuhle nomlingani kanye nabangani bakho.'
    ],


    [
      'Uma uphupha uya ebhayisikobho kusho ukuthi uzohamba uye endaweni ethile ekude.'
    ],

    [
      'Asho ukuthini amaphupho ngesitolo noma amaphupho ngemakethe? Uma uphupha usemakethe noma esitolo kuyinhlanhla yekusasa lakho. Kuhle kakhulu kwabashadile nabanini zitolo.'
    ],
    ...
    [
      'Uma uphupha ukuthi uhlala endlini yotshani kusho ukuthi uzolwa nomngani wakho kungekudala. Amaphupho ngokulwa.'
    ],

    [
      'Uma uphupha usepulazini kusho izinto ezinhle kuwe. Uyophumelela futhi ujabule ikakhulukazi uma kuyipulazi lakho noma usiza ekuvuneni izithelo nemifino.'
    ],
    ...
    [
      'Uma uphupha usemayini yamalahle kusho ukuthi uyoba nobudlelwane obulukhuni nothile owake washada ngaphambilini.'
    ],

    [
      'Uma uphupha usesekisini kusho ukuthi udinga ukulungisa impilo yakho futhi uhlukane nemikhuba emibi.'
    ],

    [
      'Uma uphupha usenkantini nabangani bakho kusho ukuthi uyoba nenjabulo nokugculiseka empilweni yakho.'
    ],

    [
      'Uma uphupha usenkampini kusho ukuthi uyoba nenhlanhla ebudlelwaneni bakho. Uma usethendeni kusho ukuthi kungadingeka usebenze kanzima kodwa uyophumelela.'
    ],

    [
      'Uma uphupha usesilaheni kusho ukuthi maduze uzobona othile okade wagcina ukumbona.'
    ],

    [
      'Uma uphupha weqa ibhuloho kusho ukuthi kunezinkinga emsebenzini. Uma uzama futhi uleqa ibhuloho kodwa libhidlikile kusho ukuthi kukhona okwesabayo.'
    ],
    ...
    [
      'Uma uphupha ukuthi kukhona obangisana naye noma oyisitha kusho ukuthi kuzofanele usebenze kanzima kakhulu ukuze uphumelele.'
    ],

    [
      'Uma uphupha ukuthi ushaye umuntu ngengqindi kusho ukuthi uzoba nenkinga maduzane – kungenzeka ngisho uboshwe mawungaqapheli. Uma omunye umuntu eshaya wena kusho ukuthi uzolwa maduzane nje kodwa kuzoba nokuthula emva kwalokho.'
    ],

    [
      'Uma uphupha ukuthi kukhona okukhuthuzile kusho ukuthi kuzofanele wenze isinqumo esibalulekile ngakho qinisekisa ukuthi uyacabangisisa yonke into.'
    ],
    ...
    [
      'Uma uphupha ukuthi ushaya umuntu uzobangelwa amahloni empilweni yakho maduzane futhi ubudlelwane bakho abuzukuphumelela. Uma omunye umuntu ekushaya, wena ulokhu uzivikela nje, kusho ukuthi ukuhletshwa kuzokuphathisa ngamahloni. Amaphupho ngokuxolelana, ukuthelelana amanzi. Amaphupho ngendlu yotshani'
    ],

    [
      'Uma uphupha ukuthu ulwa nezitha zakho uwine kusho ukuthi uzoba nenhlanhla. Uma usaba noma uhlulwa kusho ukuthi uzoba namashwa.'
    ],

    [
      'Uma uphupha ukuthi uphikisana nomuntu kusho ukuthi uzothola izindaba ezimnandi obungazilindele. Ungenza nabangani abasha.'
    ],

    [
      'Uma uphupha ukuthi ujoyina amabutho kusho ukuthi uzoshintsha umsebenzi maduzane.'
    ],

    [
      'Ukuphonswa yinto eyenziwa ngumuntu ophilayo emhlabeni. Umuntu uma engakuthandi uyakwazi ukuthi akuphonse noma kukhona umuntu okuthakathayo. Uma umuntu ekuphonsa lowomuntu usuke ewumthakathi. Ngoba usuke ekwenza into embi ngoba usuke engakufuni efuna ukuthi ufe. Omunye usuke enomona ngezinto ezenzeka kuwena nasempilweni yakho. Uma uphupha umuntu ekubiza ekubizela emaholweni noma ezitebhisini akumbele zona.'
    ],
    ...
    [
      'Uma uphupha ukuthi ubona inyoni yombani kuzoba nobunzima emndenini wakho maduzane ikakhulukazi uma inyoni ihlala phezu kwendlu yakho. Qaphela ukuduma kwezulu nombani okwesikhashana ngoba kungenzeka ukuthi usenkingeni.'
    ],
    ...
    [
      'Uma uphupha ubona noma uhogela intuthu kusho usizi empilweni yakho. Ubuningi kwentuthu kuyosho ubuningi bosizi oyobhekana nalo.'
    ],

    [
      'Uma uphupha usebenzisa umentshisi kusho ukuthi uyophumelela emizameni yakho.'
    ],

    [
      'Uma uphupha ubona ukukhanya kuyizindaba ezinhle ingqobo nje uma kuqhubeka kukhanyisa wena. Uyojabula unakekelwe umlingani wakho futhi ubenenhlanhla. Uma ukukhanya kucima ungazi ukuthi kungani kusho ukuthi uzoba senkingeni emsebenzini.'
    ],
    ...
    [
      'Uma uphupha usebumnyameni kusho ubunzima ekusaseni lakho ngaphandle uma ukwazi ukuhamba udabule ubumnyama uye ekukhanyeni. Uyophumelela futhi uchume.'
    ],

    [
      'Uma uphupha ubona ikhandlela livutha kusho ukuthi kungenzeka ube sengozini ngakho kufanele uqaphele.'
    ],

    [
      'Uma uphupha ukuthi ushisiwe kusho ukuthi maduze kuzoba nomntwana omusha emndenini wakho.'
    ],

    [
      'Uma uphupha ubona umlotha kusho ukuthi kuneshwa lakho ekudeni.'
    ],

    [
      'Uma uphupha udla amasoseji kusho ukuthi kungenzeka kunezikhathi ezinzima ekusaseni lakho.'
    ],
    ...
    [
      'Uma uphupha udla inyama yengulube noma ubhekeni kusho ukuthi uzolahlakelwa ngokuthile okusemqoka kuwe. Amaphupho ngenyama engaphekiwe.'
    ],

    [
      'Uma uphupha udla isibindi kusho ukuthi uzoba nempilo futhi uqine.'
    ],

    [
      'Uma uphupha udla inyama yemvu kusho ukuthi uzoba neshwa.'
    ],

    [
      'Uma uphupha udla izoso kungekudala uzothola umngani ozoba qotho futhi abemuhle kuwe.'
    ],

    [
      'Uma uphupha udla umqwayiba kusho ukuthi uzoba nenhlanhla nenjabulo ekusaseni lakho.'
    ],

    [
      'Uma uphupha udla isiteki senkomo isitshulu noma inyama egayiwe kusho ukuthi ishwa nokulahlekelwa kuyakunyonyobela. '
    ],
    ...
    [
      'Uma uphupha ukuthi kunephathi eyenzelwe wena kusho ukuthi uzophumelela kulokhu ohlela ukukwenza.'
    ],

    [
      'Uma uphupha ukuthi ugubha ukuhlukanisa konyaka kodwa akukhona ekupheleni konyaka uzokwenza abangani abasha abangabantu abalungile maduzane.'
    ],

    [
      'Uma uphupha ukuthi uyahleka kusho ukuthi kuzoba nosizi empilweni yakho maduzane.'
    ],

    [
      'Uma uphupha ukuthi usendleleni uya ephathini kusho ukuthi uzothola izindaba ezimbi maduzane nje. '
    ],
    ...
    [
      'Uma uphupha ukuthi usesixukwini sabantu ephathini kodwa akekho ofuna ukukhuluma nawe kusho ukuthi awuzuthandwa ngabanye abantu.'
    ],

    [
      'Uma uphupha ukuthi ugubha umkhosi kuwuphawu olubi - ngemvamisa kusho ukuthi kuzoba nezikhathi ezinzima empilweni yakho maduzane nje.'
    ],
    ...
    [
      'Uma uphupha ukuthi ubona isiswebhu kusho ukuthi uzoba nosizi nezinkinga empilweni yakho.'
    ],

    [
      'Uma uphupha ukuthi ubona inkemba kuyinhlanhla. Kusho ukuthi izinkinga zakho zizophela maduzane futhi uzothola yonke into oyifiselayo.'
    ],

    [
      'Uma uphupha ukuthi kunomuntu okujikijela ngamatshe kusho ukuthi kukhona ozama ukukuthakatha. Uma ubaleka bahlulekile kodwa uma amatshe ekushaya lokho kusho ukuthi baphumelele.'
    ],

    [
      'Uma uphupha ukuthi ubona umkhonto kufanele uqaphele ukuthi abantu obethembayo abadlali ngawe.'
    ],

    [
      'Uma uphupha ukuthi ubona ummese kusho ukuthi kunomuntu oqamba amanga kuwe futhi uzolwa nabangani bakho. Uma unikeza ummese komunye umuntu uzolimala maduzane.'
    ],

    [
      'Uma uphupha ukuthi umuntu unesibhamu ngemvamisa kusho ukuthi kunenkathazo ezayo. Uma usizwa sidubula kusho ukuthi kuzoba nokulwa empilweni yakho maduzane. Uma kunguwena odubulayo ngesibhamu kubi kakhulu.'
    ],
    ...
    [
      'Uma uphupha ukuthi kuqhume ibhomu kusho ukuthi kunengozi ezokwehlela maduzane.'
    ],
    ...
    [
      'Uma uphupha ubona iMamba kusho ukuthi abantu bazohleba futhi basho izinto ezimbi ngawe ngemva kwakho.'
    ],

    [
      'Uma ubona isibankwa kusho ukuthi othile emndenini wakho uzodumaza ukumethemba kwakho.'
    ],

    [
      'Uma uphupha ubona inyoka eluhlaza enkulu kusho ukuthi kunesitha esifuna ukukulimaza. Kungenzeka sibe ngisho ngaphakathi emndenini wakho. Amaphupho ngenyoka ensundu. Amaphupho ngenyoka emnyama enebala elimhlophe.'
    ],
    ...
    [
      'Uma uphupha ubona imivi kusho ukuthi unezitha ezifisa ukukulimaza. Uma owodwa ukunciza uzobhekana nenkinga ngokushesha kodwa uma uwubulala kusho ukuthi uzophumelela.'
    ],

    [
      'Uma uphupha ubona umuhlwa kusho ukuthi usengozini evela kubantu obucabanga ukuthi ungabethemba. '
    ],

    [
      'Uma uphupha ubona isicabucabu noma ulwembu lwesicabucabu kusho ukuthi kunezinto ezinhle eziza kuwena. Uzothola imali obungayilindele noma othile uzokuvakashela maduze.'
    ],
    ...
    [
      'Uma uphupha ubona izintwala kusho ukuthi uzobhekana nezinkinga empilweni ikakhulukazi emsebenzini. Qikelela ukukhokha izikweletu zakho unakekele nempilo yakho.'
    ],

    [
      'Uma uphupha ubona izimpukane kusho ukuthi kunabantu abanomona ngawe futhi bangazama ukukubangela inkinga.'
    ],
    ...
    [
      'Uma uphupha ukuthi usebenzisa amabhodwe namapani uzothola izindaba ezinhle ezisuka kude.'
    ],

    [
      'Uma uphupha ukuthi uphuza kujeke kusho ukuthi uzohamba indlela ende maduzane.'
    ],

    [
      'Uma uphupha ukuthi usebenzisa inkomishi kuyinhlanhla uma inkomishi igcwele kodwa yibhadi mayingenalutho.'
    ],

    [
      'Uma uphupha ukuthi usebenzisa ibhodlela ngemvamisa kuyibhadi. Uma lingenalutho phakathi noma uphuza kulo kusho ukuthi uzoba senkingeni maduzane ubhekane namahloni nokuhlekwa abantu. Kodwa uma ibhodlela ligcwele kusho ukuthi uzoba nenhlanhla.'
    ],

    [
      'Uma uphupha ukuthi usebenzisa iphinifa maduzane nje uzonikezwa into okade uyifuna.'
    ],

    [
      'Uma ubona ingubo yokulala encane kusho ukuthi uzohlangana nomngani omdala noma uphathina okade wagcina ukumbona.'
    ],

    [
      'Uma uphupha ukuthi ubona umqamelo kuyinhlanhla uma uhlanzekile kodwa kuyibhadi uma ungcolile.'
    ],

    [
      'Uma uphupha ukuthi ubona umatilasi into obuyilindele ukuthi yenzeke izofezeka.'
    ],

    [
      'Uma uphupha ukuthi ubona izingubo zokulala kuyibhadi ikakhulukazi ehlobo futhi uzobhekana nezinkinga.'
    ],

    [
      // Incomplete
      'Uma ungumuntu wesifazane uphupha ubeletha umntwana, lelo phupho lingaba nezincazelo ezahlukahlukene. Izincazelo zivela ekutheni ubelethe kanjani ephusheni lakho. Uma uphupha ubeletha kabuhlungu noma umntwana enqaba ukuphuma, lokho kuyibika lokuthi kukhona izinto okungezakho (imvamisa inhlanhla) okufanele ngabe sezifikile kuwena kepha kunomuntu okuvimbile lokho. Kanti uma uphupha ubeletha kahle nomntwana aphume ekhala ngengokujwayelekile, lokho kubika ukuthi kunenhlanhla '
    ],
    ...
    [
      'Uma uphupha ukuthi umuntu wesifazane uphuphume isisu kusho ukuthi uphathina wakho uzohlushwa yizinkinga empilweni yakhe.'
    ],
    ...
    [
      'Uma uphupha ukuthi ugqoke iveyili kusho ukuthi uzobhekana nezinkinga empilweni yakho maduzane.'
    ],
    ...
    [
      'Uma uphupha ukuthi ugqoke ibhulukwe kusho ukuthi uzoshada nomuntu othembekile ozokuphatha kahle.'
    ],
    ...
    [
      'Uma uphupha ukuthi ugqoke itshali uzokhathala ukubekezela ngoba inkinga ekuhluphayo ayizuxazululeka.'
    ],

    [
      'Uma uphupha ukuthi ugqoke izidwedwe kusho ukuthi uzoba nenhlanhla enhle.'
    ],
    ...
    [
      'Uma uphupha ukuthi ugqoke isigqoko yinhlanhla enhle uma isigqoko sisisha futhi sisemfashinini kodwa uzoba nebhadi uma sisidala futhi siwohlokile. Uma kukhona ontshontshe isigqoko sakho kusho ukuthi kukhona into ezokulahlekela.'
    ],
    ...
    [
      'Uma uphupha ukuthi ugqoke izingubo zikakotini kusho ukuthi kuzoba khona ukuphikisana empilweni yakho maduze.'
    ],

    [
      'Uma uphupha ukuthi ugqoke ijazi kusho ukuthi izinto ezimbi zizokwehlela ngakho kufanele uqaphele.'
    ],

    [
      'Uma uphupha ukuthi usebenzisa izinkinobho kusho ukuthi uzoba nenhlanhla enhle nokuthi uzophila isikhathi eside uma ungumuntu wesifazane kodwa uzoba nebhadi uma ungowesilisa.'
    ],

    [
      'Uma uphupha ngokushisa izingubo zakho kusho ukuthi impilo yakho izoba ngcono. Kodwa uma ugcina umlotha kuzoba nezinkinga ezikutholayo.'
    ],
    ...
    [
      'Uma uphupha ukuthi usebenzisa imbiliso kusho ukuthi kunemali ongayilindele ezayo maduzane.'
    ],
    ...
    [
      'Uma uphupha usebenzisa ushukela kusho ukuthi awuzukuba nemali eyanele yazo zonke izinto ozidingayo.'
    ],

    [
      'Uma uphupha ukuthi udla isobho kusho izinto ezinhle ngekusasa lakho.'
    ],
    ...
    [
      'Uma uphupha ukuthi udla irayisi kuwuphawu olubi futhi kusho ukuthi uzoba nezinkinga maduzane. '
    ],
    ...
    [
      'Uma uphupha ukuthi uphuza amasi kuwuphawu olubi uma ebolile futhi kungenzeka uxabane nophathina wakho.'
    ],
    ...
    [
      'Uma uphupha ukuthi udla ikhekhe kusho ukuthi uzoba nenjabulo empilweni yakho.'
    ],
    ...
    [
      'Uma uphupha ukuthi ufaka isitashi ezingutsheni uzoshada indoda esebenza kanzima ezokunakekela.'
    ],
    ...
    [
      'Uma uphupha ukuthi uwasha izingubo qaphela kusho ukuthi kungenzeka ulahlekelwe yinto ebalulekile kuwe maduzane. '
    ],

    [
      'Uma uphupha ukuthi uyahlakula engadini yakho kusho izinto ezinhle kuwe. Uzoba nenhlanhla nenjabulo futhi uzophila impilo ende.'
    ],
    ...
    [
      'Uma uphupha ukuthi ugaya izimbewu kusho ukuthi kunezinto ezinhle ezizayo kuwe.'
    ],
    ...
    [
      'Uma uphupha ukuthi uhlanza indlu yakho kusho ukuthi uzoba nezimali ekusaseni lakho. Uma vele uyisigwili kusho ukuthi kungenzeka ube senkingeni maduzane.'
    ],

    [
      'Uma uphupha ukuthi uphehla ibhotela kusho ukuthi uzophumelela ngenxa yokusebenza kwakho kanzima - emsebenzini wakho noma ebudlelwaneni bakho.'
    ],

    [
      
      'Uma ushawe ngesichitho kusho ukuthi kukhona osuke ekugadla engakufiseli okuhle ngoba phela isichitho siyisinyama, noma nje ngithi sihambelana naso. Uma ube nehlanhla ke namathongo akini ekubhekile uyakwazi ukuphupha okukuvezelayo ukuthi kukhona umuntu okuhambela sinyelela ongafuni ukukubona uphumelela. Kanti ke ukuphupha iphupho eliqondene naso isichitho akusiyo inhlanhla kuphela ngoba phela isichitho leso kuyenzeka sithunyelwe ngalo iphupho'
    ],

    [
      'Uma uphupha ubona amathambo kusho ukuthi uzobhekana nezikhathi ezinzima kungekudala. Uma uphupha ukuthi uphuke amathambo, ngemvamisa kusho ukuthi kuzoba nezikhathi ezinzima ezizayo ekusaseni lakho. Uma kuwukuthi imilenze yakho ephukile, kusho ukuthi uzoshada nomuntu ongenawo amandla. Uma ungowesifazane kusho ukuthi umyeni wakho uzoba yivila nesidakwa esingakwazi ukukusekela. Uma ungowesilisa, kusho ukuthi unkosikazi wakho uzoba ngumuntu olungile'
    ],
    ...
    [
      'Uma uphupha ukuthi unomphimbo obuhlungu kusho ukuthi uzoba nenhlanhla maduzane.'
    ],

    [
      'Uma uphupha ukuthi uphethwe yingxibongo kusho ukuthi uzoba yisigwili maduzane.'
    ],

    [
      'Uma uphupha uzwa ubuhlungu kakhulu kusho ukuthi kunezinto ezinhle ekusaseni lakho ikakhulukazi ngokwezimali. Uma uphupha uphuza umuthi.'
    ],

    [
      'Uma uphupha uphuza umuthi kuwuphawu lwenhlanhla enkulu. Uma uphupha ngamakhambi kusho ukuthi umuntu omaziyo ogulayo uzoba ngcono maduzane. Kungasho nokuthi uzophumelela ekusaseni lakho. Ukuphupha ngamaphilisi nakho kuhle futhi kusho ukuthi uzophepha uma uhamba izwe.'
    ],
    ...
    [
      'Uma uphupha ukuthi unochoko kusho ukuthi kunokuphatheka kabi namashwa ezayo kuwe.'
    ],
    ...
    [
      'Uma uphupha ukuthi unendlebe ebuhlungu kusho ukuthi amadlozi azama ukukutshela into kodwa wena awulalele.'
    ],
    ...
    [
      'Uma uphupha ukuthi ukhubazekile noma awukwazi ukuzihambela kusho ukuthi uzoba nempumelelo ekusaseni lakho. Ukuze wenze kwenzeke kodwa kuzofanele ufunde ukubanakekela kakhulu kunamanje abanye abantu – ikakhulukazi uma bedinga usizo.'
    ],

    [
      'Uma uphupha ukuthi ukuthi uyakhwehlela kuwuphawu oluhle. Kusho ukuthi uzophumelela emsebenzini.'
    ],

    [
      'Uma uphupha ukuthi unomkhuhlane uzodinga ukuqaphela ngoba kunezitha ezilinde ukuthatha lelothuba ngesikhathi ungenawo amandla. '
    ],
    ...
    [
      'Uma uphupha ukuthi uzizwa ungajabulile kuwuphawu oluhle. Kusho ukuthi uzoba nenhlanhla ekusaseni lakho futhi kunezinto ezinhle ezizayo kuwe.'
    ],
    ...
    [
      'Uma uphupha ukuthi kukhona okufundayo kusho ukuthi uhlakaniphile. Noma iluphi uhlobo lwendaba oyifundayo lokho uzoba nakho ekusaseni lakho.'
    ],
    ...
    [
      'Uma uphupha ukuthi unodumo ngenxa yamathalente akho empeleni kusho ukuthi awuzukwaziwa ngento oyenzayo.'
    ],
    ...
    [
      'Uma uphupha ukuthi ukwikhonsathi yomculo kusho ukuthi uzolwa kabi nomuntu.'
    ],

    [
      'Uma uphupha ukuthi uyabaza kusho ukuth uzoshada usemncane futhi ube nezingane eziningi. Uma usushadile kusho ukuthi uzophumelela emsebenzini.'
    ],

    [
      'Uma uphupha ukuthi uyadweba kusho ukuthi uzoba ngumdwebi ngelinye ilanga. Kodwa uma upenda kuwuphawu olubi ngoba kusho ukuthi umndeni wakho uzohlupheka.'
    ],

    [
      'Uma uphupha ukuthi ubukela umdlalo wasesiteji noma uphakathi kumdlalo wasesiteji kusho ukuthi uzothola izindaba ezimnandi maduzane.'
    ],
    ...
    [
      // Incomplete
      'Ukuphupha ngamakhadi esikweletu kumela ukukwazi kwakho ukuthola noma ukwenza okuthandayo empilweni ngaphandle kokusebenza kanzima noma ukukhathazeka kakhulu. Kukhombisa izinga lokukhululeka kwakho ngokuba namandla, amathuba noma ubumnandi. Ukusebenzisa ikhadi lesikweletu kusho ukuthi wena noma okuthize ngawe kukwazi ukwenza noma yini ukufeza injongo ngaphandle kwezinkinga. Ukuphupha ngabantu ababi benekhadi lesikweletu kungasho izinto ezingathandeki ngawe'
    ],

    [
      // Incomplete
      'Ukuphupha imali - ukuphupha inkece kuya ngokuthi enjani, uma kuyinkece engamaphepha lokho kusho ishobolo, kodwa ke uma kuyimali emhlophe kusho inhlanhla. Ukuphupha ngemali ewukheshi kusho amandla okufeza izinjongo ngenkululeko ephelele. Ungakhetha ukwenza okuthandayo. Inani lemali onayo ephusheni lisebenzisa izifundo zezinombolo ukuchaza okukhethayo noma ukuzizwa sengathi unamandla. Ukuthenga ngemali ewukheshi kumela ukusebenzisa amandla noma amasu'
    ],
    ...
    [
      'Ukuphupha ngokuthola imali ewuhlweza kumela imizwa emihle ngezinto ezizuzwayo empilweni uma uphapheme. Ukuzizwa ujabulile ngokuba unokungaphezu kwalokhu obunakho kuqala. Ukuqondidisa izinkinga, ukuba namandla engeziwe, noma inkulululeko ezuziwe. '
      'Kungamela nemizwa yokuba nenhlanhla. Ukuthola into ngenhlanhla noma ukuqondana ngendlela engajwayelekile empilweni lapho ophapheme khona. Amathuba agejiwe noma alahlekile asephinde abuya. Ukwazi ngokubaluleka kwento esempilweni yakho. '
      ...
      'Ukuphupha ngokuqhwabaza imali ewuhlweza ngendlela enganendaba kumela ukuzwa kokungabaluleki kwento ozibone uzuza ngayo. Inhlanhla noma okubalulekile onganendaba nakho. Ukuziphatha ngendlela enganendaba ngento eyinhlanhla eyenzekile kuwe. Ukuzizwa '
      'unenhlanhla engaphezu kwbanye abantu noma ukuzizwa umuhle ngaphezu kwabanye abantu.'
    ],

    [
      'Ukuphupha ngegolide kumela imizwa yokubaluleka kwento esempilweni yakho. Imizwa yokuceba noma ukujabulela ukuba nento enokubaluleka ibe kuwe wedwa. Amathuba anokubaluleka atholaka sonke isikhathi. Ukuzizwa ulondekile ezingeni lakho lamandla noma '
      'inkululeko yokwenza umathanda. Isenzakalo noma inzuzo eqinisekisiwe. Umuzwa wokulondeka ngento ebalulekilekuwe. Igolide lingamela nenhlanhla enhle, ingcebo, ukwelapheka, ukukhanyiseka, injabulo nempumelelo. Noma, igolide ephusheni lingemela imizwa '
      'yokuqiniseka ngamandla. Cabanga umusho othi “Okuhle njengegolide” Ukuzethemba okuphelele ngokuthi wena noma omunye umuntu ungumanqoba. Okubi ukuthi ukuphupha ngegolide kungamela imizwa yenkohlakalo, ukwenza ngokweqile noma umuntu owonakele ngezinto '
      'eziningi. Kungakhombisa nemizwa yakho engeyinhle njengokukhungatheka noma umona ngenjabulo yomunye umuntu. Izitha ezinamandla alondekile.'
    ],

    [
      // Incomplete
      'Amaphupho mayelana namaBhange Ukuphupha ngebhange kumela amasu noma amandla owaqukethe ongawasebenzisa noma yinini. Amathalente, amakhono, ukusekelwa ngokwezimali, ukusekelwa ngokomzwelo, noma izinto ezikunikeza umuzwa wokulondeka. Yilokhu oyamela kukho ukuzigcina ulondekile noma uphumelela. Ibhange lingakhombisa futhi ukuthi ubudlelwane bakho nabanye noma ukusebenzisana kwakho nabantu kunamandla kangakanani futhi kulunge kangakanani. Amandla, amasu noma abantu obasebenzisayo ukufeza izinjongo zakho.'
    ],

    [
      // Incomplete
      'Ukuphupha ngemali Ukuphupha ngemali kumela amandla okufinyelela izinhloso noma izinjongo zakho. Izinjongo zingaba ezithinta ingqondo, okungokomzwelo, noma ukufinyelela lapho okwenzeka khona okuthandayo empilweni uma usuphapheme. Ukwazi ukucabanga, ukuzwa noma ukwenza okuthandayo empilweni. Imali ikhombisa ukuthi wena noma okuthize ngobuwena bakho bunamandla amangakanani. Kuwukuzazi. Okuhle ukuthi imali imela okungenzeka, amandla namathuba. Iseluleko esiwusizo.'
    ],
    ...
    [
      'Uma uphupha ukuthi uthole igugu eligqitshiwe qaphela ngoba kuwuphawu lebhadi.'
    ],
    ...
    [
      'Uma uphupha ukuthi uyothenga lapho okunendali khona kusho ukuthi uzokhuthuzwa.'
    ],
    

    [
      'Uma uphupha ukuthi unenhlanhla futhi uyisigwili kusho ukuthi maduzane nje uzoshiyelwa into enhle ngefa.'
    ],
    ...
    [
      'Uma uphupha ukuthi unenkinga yesikweletu kusho ukuthi uzoba yisigwili.'
    ],

    [
      'Uma uphupha ukuthi ugqoke umqhele kusho ukuthi abantu bazokuthanda bakuhloniphe futhi izinto ezinhle zizokwenzeka maduzane.'
    ],

    [
      'Uma uphupha ukuthi ubhala isheke noma ukhipha imali yesheke kusho ukuthi uzothola imali maduzane kodwa yisixwayiso ukuthi uyisebenzise ngokucophelela.'
    ],
